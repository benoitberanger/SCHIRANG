function varargout = SCHIRANG_GUI
% SCHIRANG_GUI is the function that creates (or bring to focus) SCHIRANG GUI.
% Then, SCHIRANG_main is always called to start each task. It is the
% "main" program.
...
if ~isempty(figPtr) % Figure exists so brings it to the focus
    ...
    handles.(r_left.tag) = uicontrol(handles.uipanel_LeftRight,...
        ...
        'Tag',r_left.tag,...
        'BackgroundColor',figureBGcolor,...
        'Tooltip','YES will be on the LEFT side');
    ...
    handles.(r_right.tag) = uicontrol(handles.uipanel_LeftRight,...
        ...
        'Tag',r_right.tag,...
        'BackgroundColor',figureBGcolor,...
        'Tooltip','YES will be on the RIGHT side');
